...
ALTER TABLE datascribe_user ADD CONSTRAINT FK_D99C3265A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE;
...
SQL;
    ...
    public function upgrade($oldVersion, $newVersion, ServiceLocatorInterface $services)
    {
        ...
        if (Comparator::lessThan($oldVersion, '1.2.0')) {
            // Change "ON DELETE SET NULL" to "ON DELETE CASCADE", otherwise a
            // deleted Omeka S user can break the Datascribe user admin interface.
            $conn->exec("ALTER TABLE datascribe_user DROP FOREIGN KEY FK_D99C3265A76ED395");
            $conn->exec("ALTER TABLE datascribe_user ADD CONSTRAINT FK_D99C3265A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE");
        }
    }
